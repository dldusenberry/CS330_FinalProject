...
class PieChartCtrl : public wxChartCtrl, public wxChartValueObserver<std::map<wxString, SliceData>>
{
public:
    ...
    /// see wxWindow.
    PieChartCtrl(wxWindow* parent, wxWindowID id, wxPieChartData::ptr data,
...
private:
    ...
    void OnUpdate(const std::map<wxString, SliceData>& data) override;
